...
| **Readable silhouettes / palette** | Earthy Hollow, limited lantern warmth; Cap quieter visually than Pit. See art-pipeline brief checklist. |
| **Parallax / depth** | Prefer soft DepthBg + Mist + future layers over busy particle fog. Keep Cap/Pit readable. |
...
3. **Cap quieter than Pit** for dust, shake, and SFX.
...
| `TileMapLayer` + one dig API (`TerrainLayer`) | Parallel dig systems for Cap vs Pit |
